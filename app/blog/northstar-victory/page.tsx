            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-12 pt-8 border-t">
                ...
                <div className="flex gap-4">
                  <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmoron94.org%2Fblog%2Fnorthstar-victory" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="icon">
                      <Facebook className="h-5 w-5" />
                      <span className="sr-only">Share on Facebook</span>
                    </Button>
                  </a>
                  <a href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fmoron94.org%2Fblog%2Fnorthstar-victory&text=VICTORY%21+Northstar+Rail+Finally+Defeated+%E2%80%94+Highway+94+Congestion+Secured%21" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="icon">
                      <Twitter className="h-5 w-5" />
                      <span className="sr-only">Share on Twitter</span>
                    </Button>
                  </a>
                  <a href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fmoron94.org%2Fblog%2Fnorthstar-victory" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="icon">
